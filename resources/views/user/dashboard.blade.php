...
<body class="bg-gray-50 m-0 p-0">
  ...
  <div class="py-10 px-4">
    <div class="max-w-[1500px] mx-auto px-4">
      <h3 class="text-3xl font-bold text-center mb-4 text-blue-950">Hai, Selamat Datang!</h3>
      <p class="text-gray-500 text-center mb-10">Ayo jelajahi berbagai artikel disini!</p>

      <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
        @foreach ($artikels as $artikel)
          <div class="w-full bg-white rounded-xl shadow-xl overflow-hidden p-4 sm:p-6 hover:scale-105 transition duration-200 cursor-pointer"  onclick= "window.location='{{ route('user.read', $artikel->id) }}'" >
